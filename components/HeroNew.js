        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 w-full">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-left">
              ...
              >
                One powerful platform to manage all your social media. <span className="text-white font-semibold">Mobile app, web dashboard, or API</span>—your choice.
              </motion.p>
              ...
              >
                {['Mobile & Web Apps', 'Developer API', 'Auto-Scheduling', 'Analytics'].map((feature, index) => (
